...
| <a name="input_nodes_config_bundle"></a> [nodes\_config\_bundle](#input\_nodes\_config\_bundle) | n/a | <pre>object({<br>    environment             = string<br>    k8s_deb_package_version = string<br>    kubernetes_cluster      = string<br>    unique_identifier       = string<br>    controllers_sg_id       = string<br>    internal_network_cidr   = string<br>    secret_arn              = string<br>    lb_dns                  = string<br>  })</pre> | n/a | yes |
